...
theorem oddGenusCharacterProductOnSquareClassQuotient_apply_mk'
    ...
    oddGenusCharacterProductOnSquareClassQuotient d hd_neg
      ...
      exact genusCharacterOfPrimeToNormPrincipalMultipliers d P.1 hd_neg P.2
        (mk0OnPrimeToNormIdeals_surjective_of_mem_oddPrimeDiscriminantDivisors
          d P.1 P.2)
        (primeToNormPrincipalMultipliers_of_idealAvoidance d P.1) C := by
  haveI : Fact P.1.Prime := ⟨prime_of_mem_oddPrimeDiscriminantDivisors P.2⟩
...
theorem oddGenusCharacterProduct_prod_apply_eq_prod_legendreSym_of_mk0
    ...
    ((Finset.univ.prod
      (fun P : {p // p ∈ oddPrimeDiscriminantDivisors d} => by
        ...
        exact genusCharacterOfPrimeToNormPrincipalMultipliers d P.1 hd_neg P.2
          (mk0OnPrimeToNormIdeals_surjective_of_mem_oddPrimeDiscriminantDivisors
            d P.1 P.2)
          (primeToNormPrincipalMultipliers_of_idealAvoidance d P.1) C) : ℤˣ) : ℤ) =
  ...
  have happly := genusCharacterOfPrimeToNormPrincipalMultipliers_apply_mk0OnPrimeToNormIdeals
    d P.1 hd_neg P.2
      (mk0OnPrimeToNormIdeals_surjective_of_mem_oddPrimeDiscriminantDivisors d P.1 P.2)
      (primeToNormPrincipalMultipliers_of_idealAvoidance d P.1) IP
  rw [hmk] at happly
  rw [happly]
        ...
        (Finset.univ.prod
          (fun P : {p // p ∈ oddPrimeDiscriminantDivisors d} => by
            ...
            exact genusCharacterOfPrimeToNormPrincipalMultipliers d P.1 hd_neg P.2
              (mk0OnPrimeToNormIdeals_surjective_of_mem_oddPrimeDiscriminantDivisors
                d P.1 P.2)
              (primeToNormPrincipalMultipliers_of_idealAvoidance d P.1) C) : ℤˣ) = 1 := by
  ...
  change ((Finset.univ.prod
    (fun P : {p // p ∈ oddPrimeDiscriminantDivisors d} => by
      ...
      exact genusCharacterOfPrimeToNormPrincipalMultipliers d P.1 hd_neg P.2
        (mk0OnPrimeToNormIdeals_surjective_of_mem_oddPrimeDiscriminantDivisors
          d P.1 P.2)
        (primeToNormPrincipalMultipliers_of_idealAvoidance d P.1) C) : ℤˣ) : ℤ) = 1
